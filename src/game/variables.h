...
MACRO_CONFIG_INT(ClHammerSwitchDistance, cl_hammer_switch_distance, 64, 1, 500, CFGFLAG_CLIENT|CFGFLAG_SAVE, "At which distance to another tee to switch to hammer")
